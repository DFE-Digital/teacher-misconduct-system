...
{
    public class PortalTimeOffRequestPostCreateActivity : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target"))
            {
                if (context.InputParameters["Target"] is Entity)
                {
                    ...
                    // Since we have the target we can now perform the action on this postcreated entity.
                    portalBusinessLogic.PostCreateActivity(target);
